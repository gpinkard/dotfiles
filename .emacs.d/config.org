...
** faces
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :font "Unifont" :height 190 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch nil :font "Unifont" :height 190 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch-serif nil :font "Unifont" :height 190 :weight 'normal :width 'normal)
  (set-face-attribute 'variable-pitch nil :font "Unifont" :height 190 :weight 'normal :width 'normal)
#+END_SRC
* dmenu
