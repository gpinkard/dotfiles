...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'fixed-pitch nil :font "Inconsolata" :height 180)
  (set-face-attribute 'fixed-pitch-serif nil :font "Inconsolata" :height 180)
#+END_SRC
** color theme
...
#+END_SRC
** truncate
Turn on truncating for dired buffers
#+BEGIN_SRC emacs-lisp
