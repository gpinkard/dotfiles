...
** faces
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :font "Inconsolata" :height 120 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch nil :font "Inconsolata" :height 120 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch-serif nil :font "Inconsolata" :height 120 :weight 'normal :width 'normal)
  (set-face-attribute 'variable-pitch nil :font "Inconsolata" :height 120 :weight 'normal :width 'normal)
#+END_SRC
* avy
...
#+END_SRC   
** company-box
Aesthetic improvement to company mode completions.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package telephone-line
    ...
    :config
    ;; faces
    (defface t-line-color1 '((t (:foreground "#FFFFFF" :background "#125458"))) "")
    (defface t-line-color2 '((t (:foreground "#000000" :background "#b6a0ff"))) "")  
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'vterm-color-black nil :foreground "#FFFFFF" :background "#444444")
  (set-face-attribute 'vterm-color-red nil :foreground "#ff4a6f" :background "#444444")
  (set-face-attribute 'vterm-color-green nil :foreground "#60cfa2" :background "#444444")
  (set-face-attribute 'vterm-color-yellow nil :foreground "#ffd03e" :background "#444444")
  (set-face-attribute 'vterm-color-blue nil :foreground "#2fafff" :background "#444444")
  (set-face-attribute 'vterm-color-magenta nil :foreground "#c488ff" :background "#444444")
  (set-face-attribute 'vterm-color-cyan nil :foreground "#00d3d0" :background "#444444")
  (set-face-attribute 'vterm-color-white nil :foreground "#C3D0DF" :background "#444444")
#+END_SRC
** ansi-term
