...
** faces
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :font "Iosevka" :height 160 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch nil :font "Iosevka" :height 160 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch-serif nil :font "Iosevka" :height 160 :weight 'normal :width 'normal)
  (set-face-attribute 'variable-pitch nil :font "Iosevka" :height 160 :weight 'normal :width 'normal)
#+END_SRC
* dmenu
...
#+BEGIN_SRC emacs-lisp
  (use-package telephone-line
    ...
    :config
    ;; faces
    (defface t-line-tan '((t (:foreground "#E5E9F0" :background "#8D6E63"))) "")
    (defface t-line-red '((t (:foreground "#E5E9F0" :background "#c2185b"))) "")

    (setq telephone-line-faces
	'((tan . (t-line-tan . t-line-tan))
    ...
    (setq telephone-line-lhs
	  '((tan . (telephone-line-buffer-segment))
	    (red . (telephone-line-airline-position-segment))
	    (nil   . (telephone-line-vc-segment
		      telephone-line-projectile-segment))))
    (setq telephone-line-rhs
	  '((nil    . (telephone-line-misc-info-segment))
	    (red . (telephone-line-major-mode-segment))
	    (tan   . (telephone-line-minor-mode-segment))))
