...
** faces
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :font "Source Code Pro for Powerline" :height 170 :weight 'normal :width 'narrow)
  (set-face-attribute 'fixed-pitch nil :font "Source Code Pro for Powerline" :height 170 :weight 'normal :width 'narrow)
  (set-face-attribute 'fixed-pitch-serif nil :font "Source Code Pro for Powerline" :height 170 :weight 'normal :width 'narrow)
#+END_SRC
