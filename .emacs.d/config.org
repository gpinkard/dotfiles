...
** faces
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :font "Iosevka" :height 150 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch nil :font "Iosevka" :height 150 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch-serif nil :font "Iosevka" :height 150 :weight 'normal :width 'normal)
  (set-face-attribute 'variable-pitch nil :font "Roboto" :height 160 :weight 'normal :width 'normal)
#+END_SRC
* dmenu
...
#+BEGIN_SRC emacs-lisp
  (use-package telephone-line
    ...
    :config
    ;; faces
    (defface t-line-blue '((t (:foreground "#000000" :background "#c488ff"))) "")
    (defface t-line-green '((t (:foreground "#000000" :background "#2fcddf"))) "")
