...
#+END_SRC
** tabs
Customizations for tabs in emacs. By default, emacs tends to use spaces
over tabs, which is very obnoxious. These customizations make emacs use
tabs over spaces.
*** tab variables
Variables for custom tab widths.
#+BEGIN_SRC emacs-lisp
  ;; general custom tab width (java python)
  (setq custom-general-tab-width 4)
#+END_SRC
*** enable/disable functions
Custom functions to enable and disable tabs.
#+BEGIN_SRC emacs-lisp
  ...
  (defun enable-tabs ()
    ...
    (setq tab-width custom-general-tab-width))

  (global-set-key (kbd "C-c t e") 'enable-tabs)
  ...
  (global-set-key (kbd "C-c t d") 'disable-tabs)
#+END_SRC
*** tab hooks
Hooks for enabling and disabling tabs in certain modes.
#+BEGIN_SRC emacs-lisp
  ;; enable tabs in prog mode generally
  (add-hook 'prog-mode-hook 'enable-tabs)

  ;; disable tabs in lisp mode and elisp mode, tabs don't matter in lisp,
...
*** tab settings
#+BEGIN_SRC emacs-lisp
  ;; Tab widths where we want to the default tab width to be different
  ;; than custom-general-tab-width.
  ;; javascript
  (setq-default js-indent-level custom-general-tab-width)
  ;; c, cpp, java
  (setq-default c-basic-offset custom-general-tab-width)
  ;; python
  (setq-default py-indent-offset custom-general-tab-width)

  ;; make electric indent behave correctly
  (setq-default electric-indent-inhibit t)
#+END_SRC
** whitespace
#+BEGIN_SRC emacs-lisp
  ;; enable whitespace mode when we are in programming mode
  (add-hook 'prog-mode-hook 'whitespace-mode)

  (setq whitespace-style '(face tabs tab-mark trailing))

  (custom-set-faces
   '(whitespace-tab ((t (:foreground "#93a1a1")))))
...
#+END_SRC
* color theme
Currently using doom-themes (solarized light).
#+BEGIN_SRC emacs-lisp
