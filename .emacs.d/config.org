...
#+BEGIN_SRC emacs-lisp
  ...
  (setq gabe/default-font-size 140)
  ...
  ;; Language modes to enable eglot for.
  (setq gabe/supported-lsp-modes '(rust-mode typescript-mode elisp-mode))
#+END_SRC
* User Interface 
...
#+END_SRC
** rainbow delimiters
Highlight matching parens, braces, etc. using pretty colors.
#+BEGIN_SRC emacs-lisp
