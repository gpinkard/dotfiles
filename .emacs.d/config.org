...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil :font "Iosevka" :height 150 :weight 'normal :width 'normal)
#+END_SRC
* dmenu
...
#+BEGIN_SRC emacs-lisp
  (use-package telephone-line
    ...
    (defface t-line-purple '((t (:foreground "#a9b7ca" :background "#7c73cc"))) "")

    (setq telephone-line-faces
	'((red . (t-line-red . t-line-red))
	  (purple . (t-line-purple . t-line-purple))
    ...
    (setq telephone-line-rhs
	  '((nil    . (telephone-line-misc-info-segment))
	    (purple . (telephone-line-major-mode-segment))
...
** TODO look into dap-mode (debug server)
