...
#+BEGIN_SRC emacs-lisp
  ...
  (setq-default gabe/default-font-size 120)

  ;; Default font size of ace window leading character.
  (setq gabe/default-aw-font-size 500)
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'package-menu-hook #'hl-line-mode)
...
#+END_SRC
** set font size
Interactive function which sets the gabe/default-font-size variable to
set the font size globaly.
#+BEGIN_SRC emacs-lisp
  (defun gabe/set-font-size (size)
    (interactive "nFont Size: ")
    (setq gabe/default-font-size size)
...
#+BEGIN_SRC emacs-lisp
  (use-package ace-window
    ...
    (set-face-attribute 'aw-leading-char-face nil
  		      :height gabe/default-aw-font-size))
#+END_SRC
** which key
...
#+BEGIN_SRC emacs-lisp
  (use-package eglot
    :ensure t
    :hook
    ((rust-mode typescript-ts-mode js-ts-mode typescript-mode elisp-mode) . eglot-ensure)
...
#+BEGIN_SRC emacs-lisp
  (use-package indent-bars
    ...
    (setq indent-bars-width-frac 0.4)
    (setq bars-pad-frac 0.1)
    (setq indent-bars-zigzag 0.1)
    (setq indent-bars-color-by-depth nil)
    (setq indent-bars-color-by-depth '(:regexp "outline-\\([0-9]+\\)" :blend 1))
    (setq indent-bars-highlight-current-depth '(:face default :blen 0.4)))
    ;; :hook
