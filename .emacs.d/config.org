...
#+BEGIN_SRC emacs-lisp
  (when gabe/enable-hl-line-mode
    (dolist (hook '(dired-mode-hook
  		  ...
  		  nxml-mode-hook
  		  yaml-mode-hook))
      (add-hook hook (lambda () (hl-line-mode)))))
#+END_SRC
** tab for completion
Enable indentation and completion using the TAB key (completion is bound to M-TAB by default).
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** corfu
Completion at point (COmpletion in Region FUnction).
#+BEGIN_SRC emacs-lisp
  (use-package corfu
    :ensure t
    :init
