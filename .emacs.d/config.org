...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil :font "Roboto" :height 140 :weight 'normal :width 'normal)
#+END_SRC
* avy
...
#+BEGIN_SRC emacs-lisp
  (use-package telephone-line
    ...
    :config
    ;; faces
    (defface t-line-color1 '((t (:foreground "#000000" :background "#b6a0ff"))) "")
    (defface t-line-color2 '((t (:foreground "#FFFFFF" :background "#125458"))) "")
