...
** c/c++
#+BEGIN_SRC emacs-lisp
  ;; (setq lsp-langd-binary-path "/usr/bin/clangd")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'vterm-color-green nil :foreground "green4" :background "#ffffff")
  (set-face-attribute 'vterm-color-yellow nil :foreground "orange1" :background "#ffffff")
