...
#+BEGIN_SRC emacs-lisp
  ...
  (setq gabe/default-font "RobotoMono Nerd Font Mono")
  ...
  (setq gabe/emacs-config-path (format "%s%s" (pwd) "config.org"))
#+END_SRC
* User Interface 
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'js-mode-hook 'js-ts-mode-hook 'typescript-ts-mode-hook
  	  (lambda ()
...
#+BEGIN_SRC emacs-lisp
  (use-package flymake
    ...
    ("C-c f p" . flymake-goto-prev-errror))
#+END_SRC
** eglot
Emacs Polyglot (LSP).
#+BEGIN_SRC emacs-lisp
  (use-package eglot
    :ensure t
    :hook
    ((rust-mode typescript-ts-mode js-ts-mode elisp-mode) . eglot-ensure)
