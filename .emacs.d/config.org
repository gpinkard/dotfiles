...
#+END_SRC
* dmenu
dmenu for emacs, use it to launch graphical windows for exwm
#+BEGIN_SRC emacs-lisp
  (use-package dmenu
    :ensure t
    :bind
...
#+END_SRC
* terminal
Some basic configs for ansi-term. For starters, set zsh as default shell.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
* color theme
Currently, I just pick something from the doom-emacs themes collection
#+BEGIN_SRC emacs-lisp
