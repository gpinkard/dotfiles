...
** faces
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :font "Jetbrains Mono" :height 140 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch nil :font "Jetbrains Mono" :height 140 :weight 'normal :width 'normal)
  (set-face-attribute 'fixed-pitch-serif nil :font "Jetbrains Mono" :height 140 :weight 'normal :width 'normal)
  (set-face-attribute 'variable-pitch nil :font "Jetbrains Mono" :height 140 :weight 'normal :width 'normal)
#+END_SRC
* dmenu
...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-ui
    ...
    :bind
    ("C-c C-c p" . lsp-ui-doc-focus-frame)
    :config
    (setq lsp-ui-sideline-show-diagnosics))
#+END_SRC
** lsp-ivy
...
#+BEGIN_SRC emacs-lisp
  (use-package telephone-line
    ...
    :config
    ;; faces
    (defface t-line-blue '((t (:foreground "#26282c" :background "#94a5d0"))) "")
    (defface t-line-green '((t (:foreground "#26282c" :background "#90b55b"))) "")
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'vterm-color-black nil :foreground "#535353" :background "#FFFFFF")
  (set-face-attribute 'vterm-color-red nil :foreground "#d2344c" :background "#242733")
  (set-face-attribute 'vterm-color-green nil :foreground "#86dc2f" :background "#242733")
  (set-face-attribute 'vterm-color-yellow nil :foreground "#ffbb1c" :background "#242733")
  (set-face-attribute 'vterm-color-blue nil :foreground "#4F9FD2" :background "#242733")
  (set-face-attribute 'vterm-color-magenta nil :foreground "#C264C6" :background "#242733")
  (set-face-attribute 'vterm-color-cyan nil :foreground "#59b9b4" :background "#242733")
  (set-face-attribute 'vterm-color-white nil :foreground "#C3D0DF" :background "#242733")
#+END_SRC
** ansi-term
